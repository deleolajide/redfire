...
public class RedfirePlugin extends AbstractPlugin implements Plugin, PropertyEventListener, ClusterEventListener,  UserEventListener, SessionEventListener, PacketInterceptor, VoiceBridgeConstants {

	private static final String NAME 		= "redfire";
	private static final String DESCRIPTION = "Red5 Plugin for Openfire";
	public static RedfirePlugin plugin;
	...
	private void createWebAppContext() {
		...
		try {
			...
			try {
				...
				Log.error("createWebAppContext " + e);
        	}
        }
        catch(Exception e) {
