...
public abstract class OpenlinkCommand {
	...
	protected VoiceBridgeComponent voicebridgeComponent;
	...
	public OpenlinkCommand(VoiceBridgeComponent voicebridgeComponent) {
		this.voicebridgeComponent = voicebridgeComponent;

	}

	public VoiceBridgeComponent getVoiceBridgeComponent() {
	...
	public boolean hasPermission(JID requester) {
		return (AdminManager.getInstance().isUserAdmin(requester.getNode(), false) || ! getVoiceBridgeComponent().getOpenlinkProfiles(requester).isEmpty());
	}
