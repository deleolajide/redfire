...
{
	public SetFeature(VoiceBridgeComponent voicebridgeComponent)
	{
	...
	public Element execute(SessionData data, Element newCommand, Element oldCommand)
	{
		try {
			...
			String errorMessage = this.getVoiceBridgeComponent().setFeature(newCommand, profileID, featureID, value1, value2);
		...
		{
			Log.error("[VoiceBridgeOpenlink] SetFeature execute error " + e);
