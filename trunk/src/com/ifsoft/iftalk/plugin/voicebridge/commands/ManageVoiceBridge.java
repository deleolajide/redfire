...
{
	public ManageVoiceBridge(VoiceBridgeComponent voicebridgeComponent)
	{
	...
	public Element execute(SessionData data, Element newCommand, Element oldCommand)
	{
		...
		try {
			...
			String errorMessage = this.getVoiceBridgeComponent().manageVoiceBridge(newCommand, userJID, actionList);
