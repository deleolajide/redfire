...
public class IntercomCall extends OpenlinkCommand {
	...
	public IntercomCall(VoiceBridgeComponent voicebridgeComponent) {
	...
	public Element execute(SessionData data, Element newCommand, Element oldCommand)
	{
		try {
			...
			errorMessage = this.getVoiceBridgeComponent().intercomCall(newCommand, profileID, toJID, groupIntercom);
